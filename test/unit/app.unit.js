/*
  Unit tests for the demo utlity library.

  You can copy these tests to increase the unit test coverage of your own app.
*/
...
describe('#JWT Demo', () => {
  ...
  describe('#constructor', () => {
    it('should throw an error if server is not specified', () => {
      try {
